...
public class TokenHelper {
    ...
    public String generateToken(String urlPath, String method, String queryParam, String body, int expireTime) {
        if (accessKey == null || accessKey.isEmpty() || secretKey == null || secretKey.isEmpty()) {
            System.out.println("generateToken Invalid AK or SK ! ");
            throw new IllegalArgumentException("Invalid AK or SK");
        }
        if (urlPath == null || urlPath.isEmpty()) {
            System.out.println("generateToken Empty url path ");
            throw new IllegalArgumentException("Empty url path");
        }
        if (!allowedMethods.contains(method)) {
            System.out.println("generateToken invalid request method ");
        ...
        try {
            ...
            System.out.println("sbSign info:"+ sbSign);
            ...
            System.out.println("generateToken IllegalStateException! "+e);
